...
<div class="layout">
  ...
  <main>
    ...
    <section id="search">
      <h2>Find papers</h2>
      <div class="section-sub">Searches across titles, authors, raw affiliations, canonical institutions, sessions, topics, and author-declared keywords. Use up to three search conditions with AND / OR.</div>
      <div class="toolbar">
